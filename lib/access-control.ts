...
export type Capability = "request:create" | "request:read:own" | "request:read:organization" | "request:read:assigned_team" | "request:route" | "request:update_status" | "booking:create" | "booking:read:own" | "booking:manage" | "work_order:create" | "work_order:manage" | "visitor:create" | "organization:manage_members" | "reports:read" | "audit:read" | "system:manage_access";

const grants: Record<ErpRole, readonly Capability[]> = {
  customer_member: ["request:create", "request:read:own", "booking:create", "booking:read:own", "visitor:create"],
  customer_admin: ["request:create", "request:read:own", "request:read:organization", "booking:create", "booking:read:own", "visitor:create", "organization:manage_members"],
  service_desk: ["request:create", "request:read:own", "request:read:assigned_team", "request:route", "request:update_status"],
  facility_staff: ["request:create", "request:read:own", "request:read:assigned_team", "request:update_status", "booking:manage", "work_order:create", "work_order:manage"],
  facility_manager: ["request:create", "request:read:own", "request:read:assigned_team", "request:route", "request:update_status", "booking:manage", "work_order:create", "work_order:manage", "reports:read"],
