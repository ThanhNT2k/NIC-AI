...
const grants: Record<ErpRole, readonly Capability[]> = {
  ...
  facility_staff: ["request:create", "request:read:own", "request:read:assigned_team", "request:update_status", "booking:manage", "work_order:create", "work_order:manage", "cost:manage", "provider:read"],
  facility_manager: ["request:create", "request:read:own", "request:read:assigned_team", "request:route", "request:update_status", "booking:manage", "work_order:create", "work_order:manage", "asset:manage", "cost:manage", "provider:read", "provider:assign", "reports:read", "analytics:read"],
  ...
  event_manager: ["request:create", "request:read:own", "request:read:assigned_team", "request:route", "request:update_status", "event_service:manage", "event_template:manage", "provider:read", "provider:assign", "reports:read", "analytics:read"],
  ...
  auditor: ["request:read:organization", "reports:read", "analytics:read", "audit:read"],
};
